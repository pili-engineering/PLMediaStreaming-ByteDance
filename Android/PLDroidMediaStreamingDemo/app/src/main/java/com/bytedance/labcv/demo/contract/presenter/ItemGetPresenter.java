...
public class ItemGetPresenter extends ItemGetContract.Presenter {
    ...
    private void getBeautyFaceItems(List<ButtonItem> items) {
        ...
        items.add(new ButtonItem(R.drawable.ic_beauty_smooth, context.getString(R.string.beauty_face_brighten_eye), new ComposerNode(TYPE_BEAUTY_FACE_BRIGHTEN_EYE, NODE_BEAUTY_4ITEMS, "eye_detail_faceu+eyeDetailIntensity+50001")));
        items.add(new ButtonItem(R.drawable.ic_beauty_smooth, context.getString(R.string.beauty_face_remove_pouch), new ComposerNode(TYPE_BEAUTY_FACE_REMOVE_POUCH, NODE_BEAUTY_4ITEMS, "eye_detail_faceu+removePouchIntensity+50001")));
        items.add(new ButtonItem(R.drawable.ic_beauty_sharpen, context.getString(R.string.beauty_face_smile_folds), new ComposerNode(TYPE_BEAUTY_FACE_SMILE_FOLDS, NODE_BEAUTY_4ITEMS, "eye_detail_faceu+removeNasolabialFoldsIntensity+50001")));
        items.add(new ButtonItem(R.drawable.ic_beauty_sharpen, context.getString(R.string.beauty_face_whiten_teeth), new ComposerNode(TYPE_BEAUTY_FACE_WHITEN_TEETH, NODE_BEAUTY_4ITEMS, "teeth+TeethIntensity+3")));
    }
