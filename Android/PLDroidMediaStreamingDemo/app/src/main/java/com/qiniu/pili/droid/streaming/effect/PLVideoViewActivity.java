...
import com.qiniu.pili.droid.streaming.effect.utils.Config;
import com.qiniu.pili.droid.streaming.effect.utils.MediaController;
...
public class PLVideoViewActivity extends VideoPlayerBaseActivity {
    ...
    private static final String MY_PLAY_URL = "rtmp://pili-live-rtmp.liujingbo.echohu.top/liujingbo/liujingbo";
