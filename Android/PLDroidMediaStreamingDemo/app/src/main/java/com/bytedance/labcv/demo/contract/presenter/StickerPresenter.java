...
//        mStickerItems.add(new StickerItem(context.getString(R.string.sticker_happy_birth_day), R.drawable.icon_happy_birth_day, ResourceHelper.getStickerPath(context, "1cb7ee9fec82f44b9fa24f5f4d8ff97b")));
    ...
    private List<StickerItem> getAnimojiItems() {
        ...
        mAnimojiItems.add(new StickerItem(context.getString(R.string.animoji_boy), R.drawable.icon_change_face, ResourceHelper.getStickerPath(context, "animoji_boy")));
        mAnimojiItems.add(new StickerItem(context.getString(R.string.animoji_girl), R.drawable.icon_change_face, ResourceHelper.getStickerPath(context, "mm")));
