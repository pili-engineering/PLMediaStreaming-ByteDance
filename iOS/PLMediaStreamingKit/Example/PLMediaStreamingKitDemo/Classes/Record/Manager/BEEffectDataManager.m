        ...
        composerNodeDict = @{
                                      ...
                                      @(BETypeBeautyFaceBrightenEye):
                                          [[BEComposerNodeModel alloc]
                                           ...
                                           key:@"eye_detail_faceu+eyeDetailIntensity+50001"],
                                      
                                      @(BETypeBeautyFaceRemovePouch):
                                          [[BEComposerNodeModel alloc]
                                           initWithPath:@"/beauty_4Items"
                                           key:@"eye_detail_faceu+removePouchIntensity+50001"],
                                      
                                      @(BETypeBeautyFaceRemoveSmileFolds):
                                          [[BEComposerNodeModel alloc]
                                           initWithPath:@"/beauty_4Items"
                                           key:@"eye_detail_faceu+removeNasolabialFoldsIntensity+50001"],
                                      
                                      @(BETypeBeautyFaceWhitenTeeth):
                                               [[BEComposerNodeModel alloc]
                                                initWithPath:@"/beauty_4Items"
                                                key:@"teeth+TeethIntensity+3"],
